...
//             rep(to, n) {
//                 if (1<<to & i) continue;
//                 dp[i + (1<<to)][to] = min(dp[i + (1<<to)][to],
//                 dp[i][j] + cost(x[j], y[j], z[j], x[to], y[to], z[to]));
//             }
//         }
//     }
//     if (dp[(1<<n)-1][0] == inf) cout << -1 << el;
//     else cout << dp[(1<<n)-1][0] << el;
// }
